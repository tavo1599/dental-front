<template>
  <div class="mt-8 pt-4 border-t border-gray-200">
    <h3 class="text-sm font-bold text-gray-500 uppercase tracking-wider mb-4">Leyenda del Odontograma</h3>
    
    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-x-6 gap-y-4 text-xs text-gray-700">
      ...
      <!-- Caries / Defectuoso (ROJO) -->
      <div class="flex items-center gap-2">
        <div class="w-5 h-5 rounded-full bg-red-500 border border-red-600"></div>
        <span>Caries / Mal Estado</span>
      </div>
      
      <!-- Restauración (AZUL - Bueno) -->
      <div class="flex items-center gap-2">
        <div class="w-5 h-5 rounded-full bg-blue-500 border border-blue-600"></div>
        <span>Restauración (Buen Estado)</span>
      </div>

      <!-- Restauración (VERDE - Evolucionado) -->
      <div class="flex items-center gap-2">
        <div class="w-5 h-5 rounded-full bg-green-500 border border-green-600"></div>
        <span>Restauración (Evolucionado)</span>
      </div>

      <!-- Sellantes (S) -->
      <!-- Ajustado font-bold en lugar de font-extrabold para que coincida con el odontograma -->
      <div class="flex items-center gap-2">
        <div class="w-5 h-5 rounded-full bg-white border border-gray-300 flex items-center justify-center text-blue-600 font-bold text-xs">S</div>
        <span>Sellante (Bueno)</span>
      </div>
      
      <div class="flex items-center gap-2">
        <div class="w-5 h-5 rounded-full bg-white border border-gray-300 flex items-center justify-center text-red-600 font-bold text-xs">S</div>
        <span>Sellante (Defectuoso)</span>
      </div>

      <div class="flex items-center gap-2">
        <div class="w-5 h-5 rounded-full bg-white border border-gray-300 flex items-center justify-center text-green-600 font-bold text-xs">S</div>
        <span>Sellante (Evolucionado)</span>
      </div>
      ...
      <div class="flex items-center gap-2">
        <svg class="w-6 h-6" viewBox="0 0 100 100"><circle cx="50" cy="50" r="40" class="stroke-green-600" stroke-width="10" fill="none"/></svg>
        <span>Corona (Evolucionada)</span>
      </div>
      ...
      <div class="flex items-center gap-2">
        <svg class="w-6 h-6" viewBox="0 0 100 100"><line x1="50" y1="20" x2="50" y2="80" class="stroke-green-600" stroke-width="10" stroke-linecap="round"/></svg>
        <span>Endodoncia (Evol.)</span>
      </div>
...
<style scoped>
/* Estilos SVG alineados con Tooth.vue */
